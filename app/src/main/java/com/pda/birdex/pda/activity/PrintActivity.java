...
/**
 * Created by chuming.zhuang on 2016/6/21.
 */
...
//                            mTitle.setText(R.string.title_connecting);
                            title.setSaveText(getString(R.string.title_connecting));
                            break;
                        case BluetoothService.STATE_LISTEN:
                        case BluetoothService.STATE_NONE:
//                            mTitle.setText(R.string.title_not_connected);
                            title.setSaveText(getString(R.string.title_not_connected));
